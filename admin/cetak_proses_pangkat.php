...
$pdf->Cell(130,3,'',0,0);
$pdf->Cell(10, 20, 'DATA DAFTAR PROSES PENGAJUAN PANGKAT');
$pdf->Ln(15);
...
$pdf->Cell(40,6, 'Gol/Pangkat Terakhir',1,0,'C');
$pdf->Cell(40,6, 'Gol/Pangkat Tujuan',1,0,'C');
...
$query = "SELECT 
    ...
    table_pangkat.admin
    FROM table_pangkat LEFT JOIN data_pegawai ON table_pangkat.nip = data_pegawai.nip ORDER BY nama ASC";
...
while($row = mysqli_fetch_array($result)){
    ...
    $pdf->Cell(40,6,$row['gol_akhir'],1,0,'C');
    $pdf->Cell(40,6,$row['golongan_pangkat_tujuan'],1,0,'C');
