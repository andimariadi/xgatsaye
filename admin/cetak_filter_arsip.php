...
$pdf->Cell(52,6, 'TANGGAL PENGAMBILAN',1,0,'C');
$pdf->Cell(43,6, 'PENERIMA',1,0,'C');

$where = "";
if($_GET['tahun'] != 'semua') {
    $where = "WHERE YEAR(tanggal_selesai) = '".$_GET['tahun']."'";
}

$query = "SELECT * FROM riwayat_usul_berkala INNER JOIN data_pegawai ON riwayat_usul_berkala.nip = data_pegawai.nip {$where} ORDER BY tanggal_selesai DESC";
...
$no = 1;
    ...
    $pdf->Cell(52,6,$row['tanggal_selesai'],1,0,'C');
    $pdf->Cell(43,6,$row['penerima'],1,0,'L');
