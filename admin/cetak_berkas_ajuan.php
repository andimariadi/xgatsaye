...
$pdf->Cell(160,3,'',0,0);
$pdf->Cell(160, 20, 'DATA LAPORAN PROSES BERKAS AJUAN BERKALA',0, 'C');
$pdf->Ln(15);
...
$pdf->Cell(30,6, 'SK BERKALA',1,0,'C');
$pdf->Cell(30,6, 'SK PANGKAT',1,0,'C');
$pdf->Cell(30,6, 'SK JABATAN',1,0,'C');
$pdf->Cell(25,6, 'ADMIN',1,0,'C');
$pdf->Cell(25,6, 'PIMPINAN',1,0,'C');


$query = "SELECT * FROM berkas_ajuan_usul_berkala INNER JOIN data_pegawai ON berkas_ajuan_usul_berkala.nip = data_pegawai.nip ORDER BY berkas_ajuan_usul_berkala.nip DESC";
...
while($row = mysqli_fetch_array($result)){
    ...
    $pdf->Cell(25,6,$form,1,0,'C');
    $pdf->Cell(30,6,$sk_berkala_terakhir,1,0,'C');
    $pdf->Cell(30,6,$sk_pangkat_terakhir,1,0,'C');
    $pdf->Cell(30,6,$sk_pemangku_jabatan,1,0,'C');
