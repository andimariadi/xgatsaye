                                                ...
                                                <table id="example" class="table table-bordered" style="width:100%">
                                                    ...
                                                    ?>                                                         
                                                        <tr>
															...
															<td><?php echo $row['file_path_form'] != "" ? '<a href="' . base_url($row['file_path_form']).'">Document Form Usul Berkala</a>' : "";?></td>
															<td><?php echo $row['file_path_sk_berkala'] != "" ? '<a href="' . base_url($row['file_path_sk_berkala']).'">Document SK Berkala Terakhir</a>' : "";?></td>
															<td><?php echo $row['file_path_sk_pangkat'] != "" ? '<a href="' . base_url($row['file_path_sk_pangkat']).'">Document SK Pangkat Terakhir</a>' : "";?></td>
															<td><?php echo $row['file_path_sk_jabatan'] != "" ? '<a href="' . base_url($row['file_path_sk_jabatan']).'">Document SK Pemangku Jabatan</a>' : "";?></td>
