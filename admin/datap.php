                            ...
                            <?php if ($table == '1') { ?>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header" style="background-color: #cecece;">
                                            <h5>Data Pegawai</h5>
                                            <a href ="cetak_datapegawai.php" class="btn btn-outline-info btn-sm">
                                                <i class="fa fa-print"></i>
                                                Cetak Data Pegawai</a>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <form method="post" action="fungsi/simpan_pegawai.php" class="text-center pt-1">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <button class="btn btn-secondary text-left" style="width: 220px" type="button">Eselon</button>
                                                                </div>
                                                                <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" name="eselon">
                                                            </div>
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <button class="btn btn-secondary text-left" style="width: 220px" type="button">Pendidikan Terakhir</button>
                                                                </div>
                                                                <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" name="pendidikan_terakhir">
                                                                <input type="date" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" nname="tanggal_lulus_pendidikan">
                                                            </div>

                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <button class="btn btn-secondary text-left" style="width: 220px" type="button">Ked. Huk</button>
                                                                </div>
                                                                <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" name="ked_huk">
                                                            </div>

                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <button class="btn btn-secondary text-left" style="width: 220px" type="button">Jen. Peg</button>
                                                                </div>
                                                                <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" name="jen_peg">
                                                            </div>

                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <button class="btn btn-secondary text-left" style="width: 220px" type="button">Instansi Induk</button>
                                                                </div>
                                                                <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" name="instansi_induk">
                                                            </div>

                                                            <div class="input-group mb-3">
                                                                <div class="input-group-prepend">
                                                                    <button class="btn btn-secondary text-left" style="width: 220px" type="button">Instansi Kerja</button>
                                                                </div>
                                                                <input type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" name="instansi_kerja">
                                                            </div>
