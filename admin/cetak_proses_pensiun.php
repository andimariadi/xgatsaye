...
$pdf->Cell(130,3,'',0,0);
$pdf->Cell(10, 20, 'DATA DAFTAR PROSES PENSIUN');
$pdf->Ln(15);
...
$pdf->Cell(30,6, 'TMT Terakhir',1,0,'C');
...
$query = "SELECT 
    ...
    table_pensiun.admin
    FROM table_pensiun LEFT JOIN data_pegawai ON table_pensiun.nip = data_pegawai.nip ORDER BY tanggal_pensiun DESC";
...
while($row = mysqli_fetch_array($result)){
    ...
    $pdf->Cell(30,6,$row['tmt_terakhir_jabatan'],1,0,'C');
    $pdf->Cell(35,6,$row['tanggal_pensiun'],1,0,'C');
    $pdf->Cell(40, 6, $row['kategori_pensiun'], 1);
