...
$query = mysqli_query($con,"SELECT * FROM ajuan_usul_berkala INNER JOIN data_pegawai ON ajuan_usul_berkala.nip = data_pegawai.nip {$where} ORDER BY ajuan_usul_berkala.nip DESC");
