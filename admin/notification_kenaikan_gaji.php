...
$query_pangkat = mysqli_query($con,"SELECT pangkat FROM table_gajih GROUP BY pangkat ORDER BY pangkat ASC");
$query_golongan = mysqli_query($con,"SELECT golongan FROM table_gajih GROUP BY golongan ORDER BY golongan ASC");
...
<div id="modal_send_message" class="modal fade">  
    <div class="modal-dialog">
        <form method="POST"  enctype="multipart/form-data" action="fungsi/notification_kenaikan_gaji.php">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <?php while($row = mysqli_fetch_array($query_pangkat)){
                                echo '<option>' . $row['pangkat'] . '</option>';
                            }
                            ?>
                            </select>
                        </div>
                        <div class="col-6">
                            ...
                            <select name="masa_pangkat" class="form-control">
                            <?php 
                                for ($i=0; $i <= 60; $i++) { 
